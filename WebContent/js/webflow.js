...
Webflow.require('ix').init([
  {"slug":"nav-select","name":"nav select","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"opacity":1,"transition":"transform 250ms ease 0ms, opacity 250ms ease 0ms","scale":1.2}],"stepsB":[{"transition":"transform 250ms ease 0ms","scale":1}]}]}},
  {"slug":"fade-in","name":"fade in","value":{"style":{"opacity":0,"x":"0px","y":"30px"},"triggers":[{"type":"scroll","offsetTop":"10%","offsetBot":"15%","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"-20px"}],"stepsB":[]}]}},
  {"slug":"more-size","name":"more size","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"transition":"transform 500ms ease 0ms","scale":1.39}],"stepsB":[{"transition":"transform 500ms ease 0ms","scale":1}]}]}}
]);
